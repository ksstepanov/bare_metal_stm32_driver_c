...
void test_005_transaction_init(SPI_transaction_t *pOut, test_005_send_state_t current_state, test_005_data_t *pIn) {
...
void spi_tx_test_005_main(void)
{
	...
	SPI_transaction_t t;
	test_005_send_state_t state = SEND_CMD;
	...
	while (1) {
		...
		test_005_transaction_init(&t, state, &data);
